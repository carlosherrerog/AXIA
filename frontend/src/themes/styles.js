...
// ESQUEMA OSCURO — Zinc Noir (GitHub / Claude dark)
...
export const globalStyles = StyleSheet.create({
  ...
  // Tarjeta de formulario (Auth, modales) — estética Claude: redondeada, sombra difusa
  card: {
  ...
  // Inputs — más redondeados, estilo Claude
  inputContainer: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  // Botón primario — píldora, estética Claude
  primaryButton: {
